/*
  ...
  - The values [DELIVERED,CANCELLED,DEPLOYED] on the enum `UPDATE_STATUS` will be removed. If these variants are still used in the database, this will fail.
...
-- CreateIndex
CREATE INDEX "product_belongs_to" ON "Product"("id", "belongsToId");
